...
public abstract class EndlessScrollVideosListener extends RecyclerView.OnScrollListener {

    public static String TAG = EndlessScrollVideosListener.class.getSimpleName();
