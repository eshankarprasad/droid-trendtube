 ...
 */
public class FetchDMTrendingVolleyTask implements TTResponseListener<DMModel> {

    private FetchDailyMotionTrendingVideoListener listener;
    private Activity activity;

    public FetchDMTrendingVolleyTask(Activity activity, FetchDailyMotionTrendingVideoListener fetchDailyMotionTrendingVideoListener) {
