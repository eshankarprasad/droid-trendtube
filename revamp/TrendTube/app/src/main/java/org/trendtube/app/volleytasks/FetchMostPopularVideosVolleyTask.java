 ...
 */
public class FetchMostPopularVideosVolleyTask implements TTResponseListener<VideoModel> {

    private FetchVideosListener listener;
    private Activity activity;

    public FetchMostPopularVideosVolleyTask(Activity activity, FetchVideosListener fetchVideosListener) {
