 ...
 */
public class FetchYTTrendingVolleyTask implements TTResponseListener<YTModel> {

    private FetchVideosListener listener;
    private Activity activity;

    public FetchYTTrendingVolleyTask(Activity activity, FetchVideosListener fetchVideosListener) {
