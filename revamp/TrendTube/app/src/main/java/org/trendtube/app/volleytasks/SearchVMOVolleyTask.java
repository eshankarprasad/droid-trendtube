 ...
 */
public class SearchVMOVolleyTask implements TTResponseListener<VMOModel> {

    private SearchVimeoVideoListener listener;
    private Activity activity;

    public SearchVMOVolleyTask(Activity activity, SearchVimeoVideoListener searchVideoListener) {
