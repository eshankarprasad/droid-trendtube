 ...
 */
public class FetchYTTopVolleyTask implements TTResponseListener<YTModel> {

    private FetchVideosListener listener;
    private Activity activity;

    public FetchYTTopVolleyTask(Activity activity, FetchVideosListener fetchVideosListener) {
